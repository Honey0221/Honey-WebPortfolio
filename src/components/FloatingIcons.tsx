  ...
  return (
    <div className="fixed bottom-8 right-8 flex flex-col space-y-4 z-20">
      <div className="relative flex items-center group">
        ...
        <span className="absolute right-full mr-2 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-80 text-white text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-[100px] text-center">
          이메일 복사
        </span>
      </div>
