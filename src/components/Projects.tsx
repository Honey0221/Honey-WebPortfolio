...
const projectList: Project[] = [
  ...
  },
  {
    ...
    goals: [
      "FastAPI를 활용하여 개발하였고 비동기 처리를 통해 빠른 응답 속도",
    ...
    content: [
      {
        title: "담당 역할",
        items: [
          "기업 관련 파트: 기업 정보 및 리뷰 데이터 크롤링, 회원 리뷰 시스템 구현",
          "메인 페이지: 기업 검색, 기업별 재무 랭킹, 챗봇 시스템 관련 API 구현"
        ]
      },
      {
        title: "주요 기능",
        items: [
          "기업 검색 기능: 기업명, 업종별 검색 시 DB에 저장된 기업 목록 조회, DB에 없다면 실시간 크롤링 작업 수행",
          "기업 랭킹: 비정형 데이터를 커스텀 파싱 함수로 정형화한 데이터를 기반으로 랭킹 기능 구현",
          "회원 리뷰 시스템: 리뷰 CRUD 기능, 공감 및 대댓글 기능 구현",
          "챗봇 시스템: 이미 구현한 함수를 재활용하여 메인 서비스를 보조하는 기능으로 구현",
          "KOELECTRA 모델을 감정 분석에 특화되도록 파인튜닝하여 기업 리뷰 데이터를 기반으로 감정 분석 기능 구현",
        ]
      }
    ],
    retrospective: {
