    ...
    <div className="relative py-16 sm:py-20 md:py-24 z-10 w-full px-4">
      <div className="max-w-[1280px] mx-auto relative z-10">
        <div className="mb-12 sm:mb-16 md:mb-20 text-center">
          ...
          <p className="text-gray-300 mt-4 sm:mt-6 md:mt-8 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed px-2">교육 및 수상 사항을 소개합니다</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-8 sm:gap-12">
          ...
          <div className="w-full max-w-3xl animate-slide-left opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            <div className="career-card-hover overflow-hidden flex flex-col rounded-xl shadow-[0_10px_25px_rgba(59,130,246,0.15)] bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 backdrop-blur-sm">
              <div className="h-1.5 sm:h-2 bg-gradient-to-r from-blue-500 to-cyan-500"></div>
              <div className="p-5 sm:p-8 flex flex-col gap-4 sm:gap-6 text-white">
                <div className="flex items-start">
                  <div>
                    <span className="text-xs sm:text-sm text-blue-300 font-medium">2025.06.18 - 2025.08.18</span>
                    <h4 className="font-bold text-xl sm:text-2xl mt-1 text-blue-100">심화_생성형 AI 활용 백엔드 아키텍쳐 실전 프로젝트</h4>
                    <p className="text-sm sm:text-base text-blue-200 mt-1">더조은컴퓨터아카데미 구로캠퍼스</p>
                  </div>
                </div>
          ...
          <div className="w-full max-w-3xl animate-slide-right opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            <div className="career-card-hover overflow-hidden flex flex-col rounded-xl shadow-[0_10px_25px_rgba(99,102,241,0.15)] bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 backdrop-blur-sm">
              <div className="h-1.5 sm:h-2 bg-gradient-to-r from-indigo-500 to-purple-500"></div>
              <div className="p-5 sm:p-8 flex flex-col gap-4 sm:gap-6 text-white">
                <div className="flex items-start">
                  <div>
                    <span className="text-xs sm:text-sm text-indigo-300 font-medium">2024.09.23 - 2025.04.07</span>
                    <h4 className="font-bold text-xl sm:text-2xl mt-1 text-indigo-100">MSA기반 플러터 활용 Java 프론트엔드 백엔드 풀스택 웹(앱)개발</h4>
                    <p className="text-sm sm:text-base text-indigo-200 mt-1">더조은컴퓨터아카데미 인천캠퍼스</p>
                  </div>
                </div>

                <div className="space-y-4">
                  <div>
                    <h5 className="text-base sm:text-lg font-semibold text-indigo-200 mb-3 flex items-center">
                      <FaLaptopCode className="mr-2 text-indigo-400" />
                      학습 내용
                    </h5>
                    <ul className="space-y-2 sm:space-y-3 text-gray-300">
                      <li className="pl-3 career-bullet before:bg-indigo-400 text-sm sm:text-base">
